...
1. Remember how we had to set the directory in Stata? R to the rescue! And it's got version control built right in. Look under Tools>Version Control. (OMG someone build this for Stata plz.)
...
library(sandwich)
#setwd ("C:/Users/garret/Box Sync/CEGA-Programs-BITSS/1_Events/3_Workshops-Seminars\UCMerced\UCMerced2017\3-Rmarkdown")
#R is cool with relative paths, so you shouldn't even need to do this.
```
