...
\NormalTok{have <-}\StringTok{ }\NormalTok{need %in%}\StringTok{ }\KeywordTok{rownames}\NormalTok{(}\KeywordTok{installed.packages}\NormalTok{()) }\CommentTok{# see which are already}
\NormalTok{if(}\KeywordTok{any}\NormalTok{(!have)) }\KeywordTok{install.packages}\NormalTok{(need[!have]) }\CommentTok{# installs the missing ones }
